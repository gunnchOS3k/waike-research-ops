# Review packet — COMM_PD_ETHICS

## Summary

**Track:** COMM_PD_ETHICS — Communication, Professional Development, and Ethics  
**Academy:** ACADEMY_PROF_DEV  
**Extension class:** FOUNDATION  
**Content maturity:** digital_rc_present  
**Covering package:** `COMM_PD_ETHICS`
...
- **Primary sources:** `programs/communication_professional_development_and_ethics.md`, `curriculum/digital_rc/COMM_PD_ETHICS/`.
