# Accessibility — IT_SUPPORT_HARDWARE
...
Prerequisites (package): `{"course_id": "IT_SUPPORT_HARDWARE", "required": ["Willingness to keep patron PII, passwords, and SSNs out of ticket notes"], "recommended": []}`
