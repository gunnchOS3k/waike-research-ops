# Accessibility — SEVEN_GC_APPRENTICESHIP
...
Prerequisites (package): `{"course_id": "SEVEN_GC_APPRENTICESHIP", "required": ["Will label SIMULATED fixtures and refuse fabricated mentor/field completion", "Can submit lab JSON \u2014 empty/wrong/print-PASS fail", "Will not mutate production infrastructure from student labs"], "recommended": ["WIRELESS_6G claim-boundary vocabulary (complementary)", "programs/research_apprenticeship_reproducible_research.md habits"]}`
