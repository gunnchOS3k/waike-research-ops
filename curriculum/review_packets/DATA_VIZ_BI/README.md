# Review packet — DATA_VIZ_BI

## Summary

**Track:** DATA_VIZ_BI — Data Visualization and Business Intelligence  
**Academy:** ACADEMY_SOFTWARE  
**Extension class:** ADVANCED_EXTENSION  
**Content maturity:** digital_rc_present  
**Covering package:** `DATA_VIZ_BI`
...
- **Primary sources:** `programs/data_visualization_and_business_intelligence.md`, `curriculum/digital_rc/DATA_VIZ_BI/`.
