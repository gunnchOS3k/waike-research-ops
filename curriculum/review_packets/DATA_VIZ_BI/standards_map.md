...
- **SFIA9** (DRAFT): Visualisation / BI themes — draft
- **ACM_CS2023** (DRAFT): HCI / Information Management — draft
...
- Per-track YAML: `standards_alignment/by_track/DATA_VIZ_BI.yaml`
