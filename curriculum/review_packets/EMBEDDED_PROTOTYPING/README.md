# Review packet — EMBEDDED_PROTOTYPING

## Summary

**Track:** EMBEDDED_PROTOTYPING — Embedded Systems and Device Prototyping  
**Academy:** ACADEMY_HARDWARE  
**Extension class:** ADVANCED_EXTENSION  
**Content maturity:** digital_rc_present  
**Covering package:** `EMBEDDED_PROTOTYPING`
...
- **Primary sources:** `programs/embedded_prototyping.md`, `curriculum/digital_rc/EMBEDDED_PROTOTYPING/`.
