# AI policy — NETWORKING_INFRA

Source: `curriculum/digital_rc/NETWORKING_INFRA/ai_use_policy.json`
...
CIDR/datapath practicals AI_RESTRICTED; quizzes AI_DISCLOSED; capstone disclosure table required.
