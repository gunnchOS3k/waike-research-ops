# Review packet — NETWORKING_INFRA

## Summary

**Track:** NETWORKING_INFRA — Networking and Internet Infrastructure  
**Academy:** ACADEMY_NETWORKING  
**Extension class:** FOUNDATION  
**Content maturity:** canonical_entry_over_shared_content  
**Covering package:** `NETWORKING_INFRA`
...
- **Primary sources:** `programs/networking_infrastructure.md`, `curriculum/digital_rc/NETWORKING_INFRA/`.
