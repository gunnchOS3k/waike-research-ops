# Review packet — AI_ML_EDGE

## Summary

**Track:** AI_ML_EDGE — AI/ML and Edge AI Foundations  
**Academy:** ACADEMY_SOFTWARE  
**Extension class:** ADVANCED_EXTENSION  
**Content maturity:** digital_rc_present  
**Covering package:** `AI_ML_EDGE`
...
- **Primary sources:** `programs/ai_ml_edge.md`, `curriculum/digital_rc/AI_ML_EDGE/`.
