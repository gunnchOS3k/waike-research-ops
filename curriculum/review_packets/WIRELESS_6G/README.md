# Review packet — WIRELESS_6G

## Summary

**Track:** WIRELESS_6G — Wireless, DSP, and 6G Foundations  
**Academy:** ACADEMY_NETWORKING  
**Extension class:** ADVANCED_EXTENSION  
**Content maturity:** digital_rc_present  
**Covering package:** `WIRELESS_6G`
...
- **Primary sources:** `programs/wireless_6g_foundations.md`, `curriculum/digital_rc/WIRELESS_6G/`.
