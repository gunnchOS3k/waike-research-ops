# Review packet — SOFTWARE_BUILDER

## Summary

**Track:** SOFTWARE_BUILDER — Software Builder Zero-to-Hero  
**Academy:** ACADEMY_SOFTWARE  
**Extension class:** FOUNDATION  
**Content maturity:** digital_rc_present  
**Covering package:** `SOFTWARE_BUILDER`
...
- **Primary sources:** `programs/software_builder.md`, `curriculum/digital_rc/SOFTWARE_BUILDER/`.
