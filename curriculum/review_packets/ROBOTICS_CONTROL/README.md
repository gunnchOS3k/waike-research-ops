# Review packet — ROBOTICS_CONTROL

## Summary

**Track:** ROBOTICS_CONTROL — Robotics and Control  
**Academy:** ACADEMY_HARDWARE  
**Extension class:** ADVANCED_EXTENSION  
**Content maturity:** digital_rc_present  
**Covering package:** `ROBOTICS_CONTROL`
...
- **Primary sources:** `programs/robotics_and_control.md`, `curriculum/digital_rc/ROBOTICS_CONTROL/`.
