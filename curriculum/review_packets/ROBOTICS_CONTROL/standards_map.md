# Standards map — ROBOTICS_CONTROL
...
- **ABET_computing** (DRAFT): Design/experiment — draft only
- **SFIA9** (DRAFT): Systems engineering themes — draft
...
- Per-track YAML: `standards_alignment/by_track/ROBOTICS_CONTROL.yaml`
