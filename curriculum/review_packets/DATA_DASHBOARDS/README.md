# Review packet — DATA_DASHBOARDS

## Summary

**Track:** DATA_DASHBOARDS — Data, Databases, and Dashboards  
**Academy:** ACADEMY_SOFTWARE  
**Extension class:** FOUNDATION  
**Content maturity:** digital_rc_present  
**Covering package:** `DATA_DASHBOARDS`
...
- **Primary sources:** `programs/data_databases_dashboards.md`, `curriculum/digital_rc/DATA_DASHBOARDS/`.
