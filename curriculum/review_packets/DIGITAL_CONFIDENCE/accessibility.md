# Accessibility — DIGITAL_CONFIDENCE
...
Prerequisites (package): `{"course_id": "DIGITAL_CONFIDENCE", "required": ["Willingness to keep patron PII, passwords, and SSNs out of ticket notes"], "recommended": []}`
