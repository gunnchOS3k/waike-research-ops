# Review packet — DIGITAL_CONFIDENCE

## Summary

**Track:** DIGITAL_CONFIDENCE — Digital Confidence to Computer Operator  
**Academy:** ACADEMY_IT  
**Extension class:** FOUNDATION  
**Content maturity:** canonical_entry_over_shared_content  
**Covering package:** `DIGITAL_CONFIDENCE`

Operator-first path: files, accounts, tickets, and plain-language troubleshooting. Canonical entry may overlay shared GENERAL_IT content — reviewers must check that hardware-bench depth is not required for this track's PASS.

## Scope and audience

- **Audience:** WAIKE Level 1–4 learners (Gary UPNOW, apprentices, 7GC campus cohorts) unless program file narrows further.
- **Primary sources:** `programs/digital_confidence_to_operator.md`, `curriculum/digital_rc/DIGITAL_CONFIDENCE/`.
