# Lab 7 — AI/cloud notebook or offline workflow
...
2. Execute lab procedure for week 7
3. Record results in lab journal
4. Note RF/acoustic observations if relevant

## Student deliverable

`lab_07_report.md` with screenshots or tables (no sensitive locations for Gaza)
