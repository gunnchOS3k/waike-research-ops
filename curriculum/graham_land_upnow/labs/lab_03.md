# Lab 3 — Link budget or coverage model (where relevant)
...
2. Execute lab procedure for week 3
3. Record results in lab journal
4. Note RF/acoustic observations if relevant

## Student deliverable

`lab_03_report.md` with screenshots or tables (no sensitive locations for Gaza)
