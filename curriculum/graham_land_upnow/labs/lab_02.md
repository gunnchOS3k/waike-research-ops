# Lab 2 — Network diagram and connectivity audit
...
2. Execute lab procedure for week 2
3. Record results in lab journal
4. Note RF/acoustic observations if relevant

## Student deliverable

`lab_02_report.md` with screenshots or tables (no sensitive locations for Gaza)
