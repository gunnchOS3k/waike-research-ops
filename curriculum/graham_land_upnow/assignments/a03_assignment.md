# Assignment 3 — Connectivity and resilience worksheet
...
**Week 3:** Networking and connectivity (Wi-Fi, wired, cellular, edge, NTN where relevant)
...
Upload to portfolio folder: `a03_graham_land_assignment.md`
