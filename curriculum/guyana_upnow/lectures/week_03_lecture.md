# Week 3 Lecture — Networking and connectivity (Wi-Fi, wired, cellular, edge, NTN where relevant)
...
**Site module emphasis:** river/port/logistics systems

## Learning objectives

1. Explain how this week supports **WAIKE Guyana UPNOW** public benefit.
...
- Portfolio artifact: week 3 reflection memo.

## Quiz questions

1. What is the local accountability goal this week? (open-book)
2. Name one RF/acoustic tradeoff relevant to guyana. (partial credit)
