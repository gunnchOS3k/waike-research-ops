# Practical Exam — WAIKE Guyana UPNOW: Build, Map, Resilient Futures
...
**Site emphasis:** Emphasize climate/flood/logistics/data ethics.
...
Site-specific scenario using module: climate/flood data literacy
