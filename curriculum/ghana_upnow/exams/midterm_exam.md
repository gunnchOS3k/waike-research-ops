# Midterm Exam — WAIKE Ghana UPNOW: Build, Ship, Serve
...
**Site emphasis:** Emphasize mobile-first practicality and local entrepreneurship.
...
Site-specific scenario using module: mobile-first learning
