# Lab 10 — Acoustic/RF room boundary scoring
...
2. Execute lab procedure for week 10
3. Record results in lab journal
4. Note RF/acoustic observations if relevant

## Student deliverable

`lab_10_report.md` with screenshots or tables (no sensitive locations for Gaza)
