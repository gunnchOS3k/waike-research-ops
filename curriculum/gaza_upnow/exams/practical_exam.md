# Practical Exam — WAIKE Gaza UPNOW: Learn, Repair, Rebuild
...
**Site emphasis:** Trauma-aware; do not punish disruption; no sensitive locations.
...
Site-specific scenario using module: trauma-informed learning
