...
Week-1 charter freeze: write problem=checkout_latency, non_goals=['EVT claim'], success_metric=median_wait_minutes, fabricated_outcomes=false before any matrix work.
