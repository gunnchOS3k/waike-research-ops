# lab_sgc_claim_audit — claim audit

List supports vs does_not_support; external human gate.
...
python3 scripts/run_course_labs.py --lab lab_sgc_claim_audit --submission path/to/student.json
