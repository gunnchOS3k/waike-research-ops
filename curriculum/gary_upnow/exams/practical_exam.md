# Practical Exam — WAIKE Gary UPNOW: Build, Certify, Ship
...
**Site emphasis:** Emphasize local public benefit and workforce readiness.
...
Site-specific scenario using module: digital equity
