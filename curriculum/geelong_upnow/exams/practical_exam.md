# Practical Exam — WAIKE Geelong UPNOW: Design, Build, Ship
...
**Site emphasis:** Emphasize design/build, manufacturing, and regional access.
...
Site-specific scenario using module: design/build studio
