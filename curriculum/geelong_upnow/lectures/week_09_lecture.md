# Week 9 Lecture — Campus/building design studio: room program, acoustics, RF, power, safety
...
**Site module emphasis:** Traditional Owner consultation note

## Learning objectives

1. Explain how this week supports **WAIKE Geelong UPNOW** public benefit.
...
- Portfolio artifact: week 9 reflection memo.

## Quiz questions

1. What is the local accountability goal this week? (open-book)
2. Name one RF/acoustic tradeoff relevant to geelong. (partial credit)
