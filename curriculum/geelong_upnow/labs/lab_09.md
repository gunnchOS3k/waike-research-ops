# Lab 9 — Building material matrix and scoring
...
2. Execute lab procedure for week 9
3. Record results in lab journal
4. Note RF/acoustic observations if relevant

## Student deliverable

`lab_09_report.md` with screenshots or tables (no sensitive locations for Gaza)
