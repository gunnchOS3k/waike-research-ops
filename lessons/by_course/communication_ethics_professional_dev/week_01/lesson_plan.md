# Week 1 lesson plan: Week 1: Core practice — Communication, Ethics, Leadership, and Professional Development

## Plain-English purpose
Learners understand **Theory block week 1** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `7gc/cross_site/synthetic_fixture` (level 3)
...
Site/case: `7gc/cross_site/synthetic_fixture`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.

## Check for understanding
Exit ticket in exit_ticket.md; review 3 learner responses for misconception patterns.

## Homework / continuation
Complete assignment_01.md in assignment_bodies.
