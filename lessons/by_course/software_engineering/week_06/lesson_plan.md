# Week 6 lesson plan: APIs and simple architecture

## Plain-English purpose
Learners understand **Client/server** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gaza/blackout_resilient_content_plan` (level 3)
...
Site/case: `gaza/blackout_resilient_content_plan`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
