# Week 8 lesson plan: Group app demo and portfolio

## Plain-English purpose
Learners understand **Demo, reflection** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `geelong/youth_creative_tech_studio` (level 3)
...
Site/case: `geelong/youth_creative_tech_studio`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
