# Week 7 lesson plan: Documentation and deployment

## Plain-English purpose
Learners understand **README, static deploy** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gary/small_business_digital_starter_kit` (level 3)
...
Site/case: `gary/small_business_digital_starter_kit`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
