# Week 3 lesson plan: JavaScript or Python basics

## Plain-English purpose
Learners understand **Variables, logic** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gaza/crisis_learning_archive` (level 3)
...
Site/case: `gaza/crisis_learning_archive`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
