# Week 2 lesson plan: Files, folders, and organization

## Plain-English purpose
Learners understand **File management** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `germany/older_adult_digital_confidence` (level 3)
...
Site/case: `germany/older_adult_digital_confidence`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
