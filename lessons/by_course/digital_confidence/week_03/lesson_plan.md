# Week 3 lesson plan: Email and safe communication

## Plain-English purpose
Learners understand **Email, phishing awareness** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gary/homework_portfolio_access_lab` (level 3)
...
Site/case: `gary/homework_portfolio_access_lab`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
