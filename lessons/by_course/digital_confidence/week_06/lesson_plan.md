# Week 6 lesson plan: Video meetings and collaboration

## Plain-English purpose
Learners understand **Zoom/Meet basics** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `geelong/inclusive_smart_city_lab` (level 3)
...
Site/case: `geelong/inclusive_smart_city_lab`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
