# Week 1 lesson plan: Why digital confidence matters

## Plain-English purpose
Learners understand **Devices, users, community needs** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gary/family_digital_navigation_night` (level 3)
...
Site/case: `gary/family_digital_navigation_night`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
