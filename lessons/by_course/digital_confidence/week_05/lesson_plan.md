# Week 5 lesson plan: Documents and forms

## Plain-English purpose
Learners understand **Docs, PDFs, online forms** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `guyana/e_government_assistance_desk` (level 3)
...
Site/case: `guyana/e_government_assistance_desk`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
