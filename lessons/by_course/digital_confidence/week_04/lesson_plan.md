# Week 4 lesson plan: Web safety and passwords

## Plain-English purpose
Learners understand **Passwords, MFA, browser safety** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `germany/privacy_security_equity_lab` (level 3)
...
Site/case: `germany/privacy_security_equity_lab`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
