# Week 3 lesson plan: DNS, DHCP, and naming

## Plain-English purpose
Learners understand **Name resolution** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `guyana/hinterland_ict_hub_support` (level 3)
...
Site/case: `guyana/hinterland_ict_hub_support`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
