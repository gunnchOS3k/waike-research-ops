# Week 7 lesson plan: Troubleshooting playbook

## Plain-English purpose
Learners understand **Layered debug** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `ghana/power_backhaul_failure_drill` (level 3)
...
Site/case: `ghana/power_backhaul_failure_drill`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
