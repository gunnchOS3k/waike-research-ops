# Week 1 lesson plan: Security mindset and CIA triad

## Plain-English purpose
Learners understand **Confidentiality, integrity, availability** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `ghana/mobile_money_cybersecurity_workshop` (level 3)
...
Site/case: `ghana/mobile_money_cybersecurity_workshop`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
