# Week 6 lesson plan: NTN and fallback

## Plain-English purpose
Learners understand **Satellite windows** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `graham_land/satellite_outage_mode` (level 3)
...
Site/case: `graham_land/satellite_outage_mode`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
