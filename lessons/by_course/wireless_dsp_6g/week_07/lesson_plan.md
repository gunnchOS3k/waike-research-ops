# Week 7 lesson plan: Measurement plan

## Plain-English purpose
Learners understand **Edge-IO, synthetic metrics** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gary/public_wifi_quality_map` (level 3)
...
Site/case: `gary/public_wifi_quality_map`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
