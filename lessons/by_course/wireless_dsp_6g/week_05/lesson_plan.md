# Week 5 lesson plan: Latency and URLLC concepts

## Plain-English purpose
Learners understand **6G/URLLC-aligned (not certified)** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `graham_land/polar_ntn_simulation` (level 3)
...
Site/case: `graham_land/polar_ntn_simulation`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
