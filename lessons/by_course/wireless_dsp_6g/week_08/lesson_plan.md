# Week 8 lesson plan: Resilience plan capstone

## Plain-English purpose
Learners understand **Beam/NTN research connection** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `graham_land/priority_aware_data_sync` (level 3)
...
Site/case: `graham_land/priority_aware_data_sync`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
