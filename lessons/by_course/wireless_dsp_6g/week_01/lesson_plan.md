# Week 1 lesson plan: Signals and frequency

## Plain-English purpose
Learners understand **Spectrum, bandwidth** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `ghana/solar_powered_learning_hub` (level 3)
...
Site/case: `ghana/solar_powered_learning_hub`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
