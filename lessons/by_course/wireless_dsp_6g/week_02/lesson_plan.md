# Week 2 lesson plan: Sampling and digital signals

## Plain-English purpose
Learners understand **Nyquist intuition** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `graham_land/offline_scientific_workflow` (level 3)
...
Site/case: `graham_land/offline_scientific_workflow`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
