# Week 7 lesson plan: Research poster structure

## Plain-English purpose
Learners understand **Evidence maturity** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `guyana/flood_resilience_connectivity_plan` (level 3)
...
Site/case: `guyana/flood_resilience_connectivity_plan`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
