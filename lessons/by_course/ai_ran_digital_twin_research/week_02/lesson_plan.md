# Week 2 lesson plan: 7GC site profiles

## Plain-English purpose
Learners understand **Metrics, maturity** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `7gc-digital-twin repo` (level 3)
...
Site/case: `7gc-digital-twin repo`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
