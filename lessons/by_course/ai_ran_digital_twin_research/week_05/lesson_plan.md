# Week 5 lesson plan: Edge-IO telemetry

## Plain-English purpose
Learners understand **Measurement ethics** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `edge-io-measurement-node` (level 3)
...
Site/case: `edge-io-measurement-node`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
