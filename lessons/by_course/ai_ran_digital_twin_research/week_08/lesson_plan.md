# Week 8 lesson plan: Twin extension capstone

## Plain-English purpose
Learners understand **PR + report** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `gary + ghana scenes` (level 3)
...
Site/case: `gary + ghana scenes`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
