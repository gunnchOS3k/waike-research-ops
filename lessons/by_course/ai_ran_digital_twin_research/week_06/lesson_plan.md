# Week 6 lesson plan: Reproducibility

## Plain-English purpose
Learners understand **make e2e, logs** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `waike-research-ops` (level 3)
...
Site/case: `waike-research-ops`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
