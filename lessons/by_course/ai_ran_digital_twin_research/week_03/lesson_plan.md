# Week 3 lesson plan: AI-RAN policy intuition

## Plain-English purpose
Learners understand **Traffic classes** and connect it to a real 7GC scenario before building evidence.
...
- Apply the idea to case `spectrumx-ai-ran-gary` (level 3)
...
Site/case: `spectrumx-ai-ran-gary`. **Evidence:** synthetic teaching fixture / source-backed assumption. **Requires local validation** — not field-validated deployment.
