# Student packet — Software Builder Zero-to-Hero
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/software_engineering/`)
- Group capstone (see `group_projects/by_course/software_engineering/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/software_engineering/`

## Assignments
`assignment_bodies/by_course/software_engineering/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/software_engineering/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/software_engineering/portfolio_builder.md`
