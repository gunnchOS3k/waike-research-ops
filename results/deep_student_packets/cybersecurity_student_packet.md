# Student packet — Cybersecurity Foundations and SOC Readiness
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/cybersecurity/`)
- Group capstone (see `group_projects/by_course/cybersecurity/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/cybersecurity/`

## Assignments
`assignment_bodies/by_course/cybersecurity/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/cybersecurity/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/cybersecurity/portfolio_builder.md`
