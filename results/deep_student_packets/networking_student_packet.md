# Student packet — Networking and Internet Infrastructure
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/networking/`)
- Group capstone (see `group_projects/by_course/networking/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/networking/`

## Assignments
`assignment_bodies/by_course/networking/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/networking/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/networking/portfolio_builder.md`
