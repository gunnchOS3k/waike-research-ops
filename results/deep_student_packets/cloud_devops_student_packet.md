# Student packet — Cloud and DevOps Foundations
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/cloud_devops/`)
- Group capstone (see `group_projects/by_course/cloud_devops/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/cloud_devops/`

## Assignments
`assignment_bodies/by_course/cloud_devops/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/cloud_devops/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/cloud_devops/portfolio_builder.md`
