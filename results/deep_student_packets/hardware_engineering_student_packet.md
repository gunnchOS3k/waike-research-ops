# Student packet — IT Support and Hardware Foundations
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/hardware_engineering/`)
- Group capstone (see `group_projects/by_course/hardware_engineering/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/hardware_engineering/`

## Assignments
`assignment_bodies/by_course/hardware_engineering/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/hardware_engineering/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/hardware_engineering/portfolio_builder.md`
