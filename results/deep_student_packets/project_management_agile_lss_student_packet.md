...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/project_management_agile_lss/`)
- Group capstone (see `group_projects/by_course/project_management_agile_lss/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/project_management_agile_lss/`

## Assignments
`assignment_bodies/by_course/project_management_agile_lss/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/project_management_agile_lss/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/project_management_agile_lss/portfolio_builder.md`
