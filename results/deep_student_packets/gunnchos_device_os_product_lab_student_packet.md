...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/gunnchos_device_os_product_lab/`)
- Group capstone (see `group_projects/by_course/gunnchos_device_os_product_lab/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/gunnchos_device_os_product_lab/`

## Assignments
`assignment_bodies/by_course/gunnchos_device_os_product_lab/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/gunnchos_device_os_product_lab/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/gunnchos_device_os_product_lab/portfolio_builder.md`
