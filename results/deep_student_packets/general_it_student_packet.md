# Student packet — General IT and Systems Foundations
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/general_it/`)
- Group capstone (see `group_projects/by_course/general_it/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/general_it/`

## Assignments
`assignment_bodies/by_course/general_it/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/general_it/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/general_it/portfolio_builder.md`
