# Student packet — Data, Databases, and Dashboards
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/data_visualization_bi/`)
- Group capstone (see `group_projects/by_course/data_visualization_bi/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/data_visualization_bi/`

## Assignments
`assignment_bodies/by_course/data_visualization_bi/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/data_visualization_bi/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/data_visualization_bi/portfolio_builder.md`
