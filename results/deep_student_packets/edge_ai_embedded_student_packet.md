# Student packet — Embedded Systems and Device Prototyping
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/edge_ai_embedded/`)
- Group capstone (see `group_projects/by_course/edge_ai_embedded/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/edge_ai_embedded/`

## Assignments
`assignment_bodies/by_course/edge_ai_embedded/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/edge_ai_embedded/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/edge_ai_embedded/portfolio_builder.md`
