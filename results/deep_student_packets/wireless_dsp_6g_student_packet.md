# Student packet — Wireless, DSP, and 6G Foundations
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/wireless_dsp_6g/`)
- Group capstone (see `group_projects/by_course/wireless_dsp_6g/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/wireless_dsp_6g/`

## Assignments
`assignment_bodies/by_course/wireless_dsp_6g/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/wireless_dsp_6g/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/wireless_dsp_6g/portfolio_builder.md`
