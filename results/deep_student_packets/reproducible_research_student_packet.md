# Student packet — Reproducible Research and Technical Publishing
...
## What you will build
- 8 weekly artifacts
- Guided labs (see `labs/by_course/reproducible_research/`)
- Group capstone (see `group_projects/by_course/reproducible_research/`)
- Portfolio entry in evidence index

## Weekly roadmap
Weeks 1–8 in `lessons/by_course/reproducible_research/`

## Assignments
`assignment_bodies/by_course/reproducible_research/assignment_01.md` through `assignment_08.md`

## Group project
`group_projects/by_course/reproducible_research/project_brief.md`
...
## Portfolio checklist
See `student_workbooks/by_course/reproducible_research/portfolio_builder.md`
