# Learning track — geelong

```json
{
  "site_id": "geelong",
  "local_context": "Inclusive smart-city, accessibility, youth creative-tech",
  "beginner_pathway": {
    "steps": [
      "run smoke test",
      "read problem map"
  ...
  "local_capstone": "geelong capstone: campus operational demo",
  "family_community_activity": "geelong family learning night (template)",
  "instructor_role": "local instructor owns pacing",
  "local_mentor_role": "mentor reviews ethics",
  "gunnchai3k_support_mode": "tutor_cards",
  "portfolio_artifact": "results/campus_learning/geelong_portfolio.md",
