# Learning track — ghana

```json
{
  "site_id": "ghana",
  "local_context": "Mobile-first, power-aware, affordability-aware inclusion node",
  "beginner_pathway": {
    "steps": [
      "run smoke test",
      "read problem map"
  ...
  "local_capstone": "ghana capstone: campus operational demo",
  "family_community_activity": "ghana family learning night (template)",
  "instructor_role": "local instructor owns pacing",
  "local_mentor_role": "mentor reviews ethics",
  "gunnchai3k_support_mode": "tutor_cards",
  "portfolio_artifact": "results/campus_learning/ghana_portfolio.md",
