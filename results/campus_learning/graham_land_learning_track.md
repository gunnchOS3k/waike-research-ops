# Learning track — graham_land

```json
{
  "site_id": "graham_land",
  "local_context": "Polar/outpost NTN, low-power, offline-first scientific workflow",
  "beginner_pathway": {
    "steps": [
      "run smoke test",
      "read problem map"
  ...
  "local_capstone": "graham_land capstone: campus operational demo",
  "family_community_activity": "graham_land family learning night (template)",
  "instructor_role": "local instructor owns pacing",
  "local_mentor_role": "mentor reviews ethics",
  "gunnchai3k_support_mode": "tutor_cards",
  "portfolio_artifact": "results/campus_learning/graham_land_portfolio.md",
