...
{
  "site_id": "gaza",
  "local_context": "Remote-first humanitarian education continuity and no-data-harm crisis resilience",
  "beginner_pathway": {
    "steps": [
      "run smoke test",
      "read problem map"
  ...
  "local_capstone": "gaza capstone: campus operational demo",
  "family_community_activity": "gaza family learning night (template)",
  "instructor_role": "local instructor owns pacing",
  "local_mentor_role": "mentor reviews ethics",
  "gunnchai3k_support_mode": "tutor_cards",
  "portfolio_artifact": "results/campus_learning/gaza_portfolio.md",
